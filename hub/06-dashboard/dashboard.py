...
# Drawn as the "normal" reference on the camera trend. Update if the baseline is
# re-established (new growth stage, camera reposition, etc.).
GREEN_RATIO_BASELINE_LOW = 0.464     # p10
GREEN_RATIO_BASELINE_HIGH = 0.556    # p90
